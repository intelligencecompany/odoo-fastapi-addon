...
@router.post("/api/onboarding.onboarding.step", response_model=Model.OnboardingStepModel, tags=["onboarding"])
async def post_blog(data:dict, api_key:str = Depends(api_key_header)):
    ...
    results = Model.OnboardingStepModel.from_execute_kw(results)
