...
@router.post("/api/mail.activity.schedule", response_model=Model.ActivityscheduleplanWizardModel, tags=["mail"])
async def post_blog(data:dict, api_key:str = Depends(api_key_header)):
    ...
    results = Model.ActivityscheduleplanWizardModel.from_execute_kw(results)
