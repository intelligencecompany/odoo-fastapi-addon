...
@router.get("/api/ir.demo_failure.wizard", response_model=List[Model.DemoFailurewizardModel], tags=['ir', 'demo_failure', 'wizard'])
async def get_demofailurewizard(fields:str = '', offset:int = 0, limit:int = 10, api_key:str = Depends(api_key_header)):
...
@router.post("/api/ir.demo_failure.wizard", response_model=Model.DemoFailurewizardModel, tags=['ir', 'demo_failure', 'wizard'])
...
@router.put("/api/ir.demo_failure.wizard/{post_id}", response_model=Dict[str, str], tags=['ir', 'demo_failure', 'wizard'])
