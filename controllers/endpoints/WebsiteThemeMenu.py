...
@router.get("/api/theme.website.menu", response_model=List[Model.WebsiteThemeMenuModel], tags=['theme', 'website', 'menu'])
async def get_websitethememenu(fields:str = '', offset:int = 0, limit:int = 10, api_key:str = Depends(api_key_header)):
...
@router.post("/api/theme.website.menu", response_model=Model.WebsiteThemeMenuModel, tags=['theme', 'website', 'menu'])
...
@router.put("/api/theme.website.menu/{post_id}", response_model=Dict[str, str], tags=['theme', 'website', 'menu'])
