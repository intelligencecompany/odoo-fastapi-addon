...
class EmailresendwizardModel(BaseModel):
    ...
    mail_message_id: Optional[int] = Field(None, alias="mail_message_id", title="Message", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['EmailresendwizardModel']:
        transformed = []
        schema = EmailresendwizardModel.model_json_schema()
