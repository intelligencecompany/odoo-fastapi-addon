...
class BlogPostModel(BaseModel):
    ...
    name: str = Field("", alias="name", title="Title", description="")
    ...
    blog_id: int = Field(0, alias="blog_id", title="Blog", description="")
    ...
    subtitle: Optional[str] = Field(None, alias="subtitle", title="Sub Title", description="")
    author_avatar: Optional[Any] = Field(None, alias="author_avatar", title="Avatar", description="")
    author_name: Optional[str] = Field(None, alias="author_name", title="Author Name", description="")
    active: Optional[bool] = Field(None, alias="active", title="Active", description="")
    content: Optional[Any] = Field(None, alias="content", title="Content", description="")
    teaser: Optional[Any] = Field(None, alias="teaser", title="Teaser", description="")
    teaser_manual: Optional[Any] = Field(None, alias="teaser_manual", title="Teaser Content", description="")
    create_date: Optional[str] = Field(None, alias="create_date", title="Created on", description="")
    published_date: Optional[str] = Field(None, alias="published_date", title="Published Date", description="")
    post_date: Optional[str] = Field(None, alias="post_date", title="Publishing date", description="The blog post will be visible for your visitors as of this date on the website if it is set as published.")
    create_uid: Optional[int] = Field(None, alias="create_uid", title="Created by", description="")
    write_date: Optional[str] = Field(None, alias="write_date", title="Last Updated on", description="")
    write_uid: Optional[int] = Field(None, alias="write_uid", title="Last Contributor", description="")
    ...
    @classmethod
    def from_execute_kw(cls, item:Dict[str, Any]) -> 'BlogPostModel':
        filtered_item = {}
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['BlogPostModel']:
        transformed = []
        schema = BlogPostModel.model_json_schema()
