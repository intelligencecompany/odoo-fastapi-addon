...
class UpdateaddressofpartnerModel(BaseModel):
    ...
    letter_id: Optional[int] = Field(None, alias="letter_id", title="Letter", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['UpdateaddressofpartnerModel']:
        transformed = []
        schema = UpdateaddressofpartnerModel.model_json_schema()
