...
class MailBlacklistModel(BaseModel):
    ...
    email: str = Field("", alias="email", title="Email Address", description="This field is case insensitive.")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['MailBlacklistModel']:
        transformed = []
        schema = MailBlacklistModel.model_json_schema()
