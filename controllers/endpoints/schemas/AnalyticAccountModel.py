...
class AnalyticAccountModel(BaseModel):
    ...
    name: str = Field("", alias="name", title="Analytic Account", description="")
    plan_id: int = Field(0, alias="plan_id", title="Plan", description="")
    root_plan_id: Optional[int] = Field(None, alias="root_plan_id", title="Root Plan", description="")
    ...
    line_ids: Optional[List[int]] = Field(None, alias="line_ids", title="Analytic Lines", description="")
    ...
    active: Optional[bool] = Field(None, alias="active", title="Active", description="Deactivate the account.")
    color: Optional[int] = Field(None, alias="color", title="Color Index", description="")
    balance: Optional[float] = Field(None, alias="balance", title="Balance", description="")
    debit: Optional[float] = Field(None, alias="debit", title="Debit", description="")
    credit: Optional[float] = Field(None, alias="credit", title="Credit", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['AnalyticAccountModel']:
        transformed = []
        schema = AnalyticAccountModel.model_json_schema()
