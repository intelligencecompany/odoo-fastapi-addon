...
class GroupofdashboardsModel(BaseModel):
    id: Optional[int] = Field(None, alias="id", title="ID", description="")
    name: str = Field("", alias="name", title="Name", description="")
    dashboard_ids: Optional[List[int]] = Field(None, alias="dashboard_ids", title="Dashboard", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['GroupofdashboardsModel']:
        transformed = []
        schema = GroupofdashboardsModel.model_json_schema()
