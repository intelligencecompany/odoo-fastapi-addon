...
class EmailAliasesMixinlightModel(BaseModel):
    ...
    alias_id: Optional[int] = Field(None, alias="alias_id", title="Alias", description="")
    ...
    @classmethod
    def from_execute_kw(cls, item:dict[str, any]) -> 'EmailAliasesMixinlightModel':
        filtered_item = {}
        schema = EmailAliasesMixinlightModel.model_json_schema()
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['EmailAliasesMixinlightModel']:
        transformed = []
        schema = EmailAliasesMixinlightModel.model_json_schema()
