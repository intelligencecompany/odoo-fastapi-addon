...
class IndustryModel(BaseModel):
    ...
    full_name: Optional[str] = Field(None, alias="full_name", title="Full Name", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['IndustryModel']:
        transformed = []
        schema = IndustryModel.model_json_schema()
