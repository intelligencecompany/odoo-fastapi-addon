...
class PageModel(BaseModel):
    ...
    url: str = Field("", title="Page URL", description="")
    ...
    website_indexed: Optional[bool] = Field(None, title="Is Indexed", description="")
    date_publish: Optional[str] = Field(None, title="Publishing Date", description="")
    is_in_menu: Optional[bool] = Field(None, title="Is In Menu", description="")
    is_homepage: Optional[bool] = Field(None, title="Homepage", description="")
    ...
    header_text_color: Optional[str] = Field(None, title="Header Text Color", description="")
