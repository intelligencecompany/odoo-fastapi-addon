...
class MailMainAttachmentmanagementModel(BaseModel):

    message_main_attachment_id: Optional[int] = Field(None, alias="message_main_attachment_id", title="Main Attachment", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['MailMainAttachmentmanagementModel']:
        transformed = []
        schema = MailMainAttachmentmanagementModel.model_json_schema()
