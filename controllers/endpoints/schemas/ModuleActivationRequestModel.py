...
class ModuleActivationRequestModel(BaseModel):
    ...
    user_ids: Optional[List[int]] = Field(None, alias="user_ids", title="Send to:", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['ModuleActivationRequestModel']:
        transformed = []
        schema = ModuleActivationRequestModel.model_json_schema()
