...
class ActionURLModel(BaseModel):
    ...
    url: Any = Field(None, alias="url", title="Action URL", description="")
    target: Any = Field(None, alias="target", title="Action Target", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['ActionURLModel']:
        transformed = []
        schema = ActionURLModel.model_json_schema()
