...
class ModelPageModel(BaseModel):
    ...
    page_name: str = Field("", alias="page_name", title="Name", description="The name is used to generate the URL and is shown in the browser title bar")
    ...
    name_slugified: Optional[str] = Field(None, alias="name_slugified", title="URL", description="The name of the page usable in a URL")
    page_type: Optional[Any] = Field(None, alias="page_type", title="Page Type", description="The type of the page. If set, it indicates whether the page displays a list of records or a single record")
    record_domain: Optional[str] = Field(None, alias="record_domain", title="Domain", description="Domain to restrict records that can be viewed publicly")
    default_layout: Optional[Any] = Field(None, alias="default_layout", title="Default Layout", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['ModelPageModel']:
        transformed = []
        schema = ModelPageModel.model_json_schema()
