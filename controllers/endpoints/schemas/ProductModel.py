...
class ProductModel(BaseModel):
    ...
    is_product_variant: Optional[bool] = Field(None, alias="is_product_variant", title="Is a product variant", description="")
    product_variant_count: Optional[int] = Field(None, alias="product_variant_count", title="# Product Variants", description="")
    barcode: Optional[str] = Field(None, alias="barcode", title="Barcode", description="")
    ...
    @classmethod
    def from_execute_kw(cls, item:dict) -> 'ProductModel':
        filtered_item = {}
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['ProductModel']:
        transformed = []
        schema = ProductModel.model_json_schema()
