...
class UsersDeletionRequestModel(BaseModel):
    ...
    user_id_int: Optional[int] = Field(None, alias="user_id_int", title="User Id", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['UsersDeletionRequestModel']:
        transformed = []
        schema = UsersDeletionRequestModel.model_json_schema()
