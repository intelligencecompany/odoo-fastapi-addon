...
class MergePartnerLineModel(BaseModel):
    ...
    min_id: Optional[int] = Field(None, alias="min_id", title="MinID", description="")
    aggr_ids: str = Field("", alias="aggr_ids", title="Ids", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['MergePartnerLineModel']:
        transformed = []
        schema = MergePartnerLineModel.model_json_schema()
