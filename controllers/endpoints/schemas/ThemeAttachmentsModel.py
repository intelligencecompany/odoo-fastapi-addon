...
class ThemeAttachmentsModel(BaseModel):
    ...
    key: str = Field("", alias="key", title="Key", description="")
    copy_ids: Optional[List[int]] = Field(None, alias="copy_ids", title="Attachment using a copy of me", description="")
    ...
    @classmethod
    def list_from_execute_kw(cls, data:List[dict], fields:List[str] = []) -> List['ThemeAttachmentsModel']:
        transformed = []
        schema = ThemeAttachmentsModel.model_json_schema()
