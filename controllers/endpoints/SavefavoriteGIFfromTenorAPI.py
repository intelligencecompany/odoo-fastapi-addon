...
@router.post("/api/discuss.gif.favorite", response_model=Model.SavefavoriteGIFfromTenorAPIModel, tags=["discuss"])
async def post_blog(data:dict, api_key:str = Depends(api_key_header)):
    ...
    results = Model.SavefavoriteGIFfromTenorAPIModel.from_execute_kw(results)
