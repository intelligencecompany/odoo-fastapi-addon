...
@router.post("/api/product.attribute.custom.value", response_model=Model.ProductAttributeCustomValueModel, tags=["product"])
async def post_blog(data:dict, api_key:str = Depends(api_key_header)):
    ...
    results = Model.ProductAttributeCustomValueModel.from_execute_kw(results)
