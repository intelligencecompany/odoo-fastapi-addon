...
@router.get("/api/mail.blacklist.remove", response_model=List[Model.RemoveemailfromblacklistwizardModel], tags=['mail', 'blacklist', 'remove'])
async def get_removeemailfromblacklistwizard(fields:str = '', offset:int = 0, limit:int = 10, api_key:str = Depends(api_key_header)):
...
@router.post("/api/mail.blacklist.remove", response_model=Model.RemoveemailfromblacklistwizardModel, tags=['mail', 'blacklist', 'remove'])
...
@router.put("/api/mail.blacklist.remove/{post_id}", response_model=Dict[str, str], tags=['mail', 'blacklist', 'remove'])
