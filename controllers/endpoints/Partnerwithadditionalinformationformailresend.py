...
@router.post("/api/mail.resend.partner", response_model=Model.PartnerwithadditionalinformationformailresendModel, tags=["mail"])
async def post_blog(data:dict, api_key:str = Depends(api_key_header)):
    ...
    results = Model.PartnerwithadditionalinformationformailresendModel.from_execute_kw(results)
