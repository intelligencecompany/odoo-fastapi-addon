...
@router.get("/api/theme.ir.attachment", response_model=List[Model.ThemeAttachmentsModel], tags=['theme', 'ir', 'attachment'])
async def get_themeattachments(fields:str = '', offset:int = 0, limit:int = 10, api_key:str = Depends(api_key_header)):
...
@router.post("/api/theme.ir.attachment", response_model=Model.ThemeAttachmentsModel, tags=['theme', 'ir', 'attachment'])
...
@router.put("/api/theme.ir.attachment/{post_id}", response_model=Dict[str, str], tags=['theme', 'ir', 'attachment'])
