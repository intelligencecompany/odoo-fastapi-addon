...
@router.get("/api/base.document.layout", response_model=List[Model.CompanyDocumentLayoutModel], tags=['base', 'document', 'layout'])
async def get_companydocumentlayout(fields:str = '', offset:int = 0, limit:int = 10, api_key:str = Depends(api_key_header)):
...
@router.post("/api/base.document.layout", response_model=Model.CompanyDocumentLayoutModel, tags=['base', 'document', 'layout'])
...
@router.put("/api/base.document.layout/{post_id}", response_model=Dict[str, str], tags=['base', 'document', 'layout'])
