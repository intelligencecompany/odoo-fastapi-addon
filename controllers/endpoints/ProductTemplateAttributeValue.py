...
@router.post("/api/product.template.attribute.value", response_model=Model.ProductTemplateAttributeValueModel, tags=["product"])
async def post_blog(data:dict, api_key:str = Depends(api_key_header)):
    ...
    results = Model.ProductTemplateAttributeValueModel.from_execute_kw(results)
