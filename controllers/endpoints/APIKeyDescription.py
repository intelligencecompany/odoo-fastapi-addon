...
@router.post("/api/res.users.apikeys.description", response_model=Model.APIKeyDescriptionModel, tags=["res"])
async def post_blog(data:dict, api_key:str = Depends(api_key_header)):
    ...
    results = Model.APIKeyDescriptionModel.from_execute_kw(results)
